...
public final class StripeWebhooksSpark1App {
    private static final Logger LOGGER =
        LoggerFactory.getLogger(StripeWebhooksSpark1App.class);

    private StripeWebhooksSpark1App() { }

    public static void main(final String[] args) throws IOException {
        // Read Stripe secret API key
        ClassLoader classLoader = StripeWebhooksSpark1App.class
                .getClassLoader();
                ...
                try {
                    ...
                    if (eventJson.getUserId() != null) {
                        requestOptions = RequestOptions.builder()
                                .setStripeAccount(eventJson.getUserId())
                                .build();
                    }
